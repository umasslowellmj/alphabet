...
class EngWordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create eng_word" do
    assert_difference('EngWord.count') do
      post eng_words_url, params: { eng_word: {  } }
    end

    assert_redirected_to eng_word_url(EngWord.last)
  end
  ...
  test "should update eng_word" do
    patch eng_word_url(@eng_word), params: { eng_word: {  } }
    assert_redirected_to eng_word_url(@eng_word)
  end
  ...
  test "should destroy eng_word" do
    ...
    assert_redirected_to eng_words_url
  end
end
